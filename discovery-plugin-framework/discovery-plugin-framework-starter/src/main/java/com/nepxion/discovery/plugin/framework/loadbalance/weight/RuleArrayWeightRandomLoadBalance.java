...
public class RuleArrayWeightRandomLoadBalance extends AbstractArrayWeightRandomLoadBalance<WeightFilterEntity> implements RuleWeightRandomLoadBalance<WeightFilterEntity> {
