...
public class RuleDivisorWeightRandomLoadBalance extends AbstractDivisorWeightRandomLoadBalance<WeightFilterEntity> {
    private RuleWeightRandomLoadBalanceAdapter ruleWeightRandomLoadBalanceAdapter;

    public RuleDivisorWeightRandomLoadBalance(PluginAdapter pluginAdapter) {
