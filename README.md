...
| 版本 | 服务实例的版本 | 蓝绿灰度发布<br>路由转移 | ① 版本条件匹配蓝绿发布<br>② 版本权重灰度发布<br>③ 版本故障转移，即无法找到相应版本的服务实例，路由到老的稳定版本的实例<br>④ 版本偏好，即非蓝绿灰度发布场景下，路由到老的稳定版本的实例 |
| 区域 | 服务实例的区域，适用于多机房或者多环境 | 蓝绿灰度发布<br>路由转移 | ① 区域条件匹配蓝绿发布<br>② 区域权重灰度发布<br>③ 区域调试路由，即既支持多区域服务路由隔离，也支持特殊场景下不同区域间的服务相互调用（一般视作调试手段）。不支持区域故障转移和偏好 |
