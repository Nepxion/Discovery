...
注意：
1. 6.x.x版本同时适用于Finchley、Greenwich和Hoxton以及未来的更高版本，将继续维护
2. 5.x.x（适用于Greenwich）和4.x.x（适用于Finchley）版本不再维护，并入到6.x.x版本，分别对应的5.6.0和4.15.0是最后一个稳定版本
3. 3.x.x（适用于Edgware）为照顾老的技术栈公司，将继续维护
4. 2.x.x和1.x.x已废弃
