...
| --- | --- | --- | --- | --- |
| 5.2.0 | 维护中，可用 | Greenwich | 2.1.x.RELEASE | 0.9.x.RELEASE |
| 4.10.0 | 维护中，可用 | Finchley | 2.0.x.RELEASE | 0.2.x.RELEASE |
| 3.10.0 | 维护中，可用 | Edgware | 1.5.x.RELEASE | 0.1.x.RELEASE |
...
spring.application.strategy.rest.intercept.log.print=true
