...
public class SentinelStrategyRuleConsulProcessor extends ConsulProcessor {
    @Autowired
    ...
    public SentinelStrategyRuleConsulProcessor(SentinelStrategyRuleType sentinelStrategyRuleType) {
