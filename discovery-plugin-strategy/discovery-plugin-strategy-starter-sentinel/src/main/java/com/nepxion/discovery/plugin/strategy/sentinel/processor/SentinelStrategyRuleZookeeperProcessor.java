package com.nepxion.discovery.plugin.strategy.sentinel.processor;
...
public class SentinelStrategyRuleZookeeperProcessor extends ZookeeperProcessor {
    @Autowired
    ...
    public SentinelStrategyRuleZookeeperProcessor(SentinelStrategyRuleType sentinelStrategyRuleType) {
