...
public class SentinelStrategyRuleRedisProcessor extends RedisProcessor {
    @Autowired
    ...
    public SentinelStrategyRuleRedisProcessor(SentinelStrategyRuleType sentinelStrategyRuleType) {
