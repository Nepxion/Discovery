...
public class GatewayStrategyUpdateAllRouteEvent implements Serializable {
    ...
    public GatewayStrategyUpdateAllRouteEvent(List<GatewayStrategyRouteEntity> gatewayStrategyRouteEntityList) {
